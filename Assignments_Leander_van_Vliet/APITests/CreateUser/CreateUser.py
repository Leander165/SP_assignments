...
class TestCreateUser(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        # Check if response json equals the name and job, otherwise an error message is given.
        ...
        # Check if an ID and a "createdAt" are in the response, otherwise an error message is given.
