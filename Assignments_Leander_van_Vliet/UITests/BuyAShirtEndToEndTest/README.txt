...
The test checks if the user can successfully order a shirt at the webshop and a screenshot of the order is added. The test passes when the "back to products" button after checkout is visible
